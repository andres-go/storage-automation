...
def create_item_checked_board(board_id, obj_register, column_mapping):
    """
    ...
    if obj_register._person and 'person' in column_mapping:
        column_values[column_mapping['person']] = obj_register._person
    if obj_register._motive and 'motive' in column_mapping:
